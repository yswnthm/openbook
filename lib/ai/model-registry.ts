...
export const MODEL_REGISTRY = {
    ...
    'openai-gpt-5-mini': {
        provider: 'openai',
        providerModel: 'gpt-5-mini-2025-08-07',
        label: 'GPT 5 Mini',
    ...
    'openai-gpt-5-nano': {
        provider: 'openai',
        providerModel: 'gpt-5-nano-2025-08-07',
        label: 'GPT 5 Nano',
    ...
    'google-gemini-2-5-pro': {
        provider: 'google',
        providerModel: 'models/gemini-2.5-pro',
    ...
    'google-default': {
        ...
        description: 'Default preview build of the next generation multimodal model.',
        providerLabel: 'Google',
        capabilities: ['Preview', 'Multimodal'],
        contextWindow: '1M',
        tier: 'preview',
